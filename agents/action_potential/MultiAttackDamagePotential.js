...
class MultiAttackDamagePotential {
	
	/**
	 * Create an MultiAttackDamagePotential object. Used to hold information about the 
	 * highest possible damage output from a multi-target attack action.
	...
	constructor(actor, targets){
		...
		for(let target of targets){
			damage = Utils.mapAttackStatToDamage(actor, target, this.scalar);
...
module.exports = MultiAttackDamagePotential;